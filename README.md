...
Thanks to Johns Hopkins University Center for Systems Science and Engineering (JHU CSSE) https://systems.jhu.edu/, for creating and maintaining https://github.com/CSSEGISandData/COVID-19 . Thanks to the ongoing effort of [Omar Laraqui](https://github.com/Omaroid), for providing an [API through which JHU CSSE data can be easily obtained](https://github.com/Omaroid/Covid-19-API). 
